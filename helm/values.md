...
| nginx.additionalRootConf.fileName | string | `"additionalRootConf.conf"` | Name of the additional configuration file to be included in the NGINX root path configuration (should be mounted to the "config" directory) |
